...
export const front = {
  landing: {
    ...
    boardNote: "Joseki’s own move picker, playing both sides: the heuristic the house players fall back on when KataGo’s human-style network is not loaded. The 19-line game behind the page is the same engine.",
