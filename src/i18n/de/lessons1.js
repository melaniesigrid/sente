...
export const lessons1 = {
  ...
  "no-liberty-capture": {
    ...
    steps: {
      ...
      1: {
        text: "Die letzte Freiheit von Weiß liegt in seiner eigenen Form. Schwarz am Zug. Der Zug sieht wie Selbstmord aus, aber Gefangene werden zuerst abgerechnet.",
  ...
  "atari-escape": {
    ...
    steps: {
      0: { text: "Eine Freiheit bleibt, und diese Freiheit ist der einzige Ausweg. Dorthin herauszuziehen macht eine Zweisteinkette mit drei Freiheiten, und die Gefahr ist vorerst vorbei." },
      1: {
