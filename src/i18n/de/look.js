...
export const look = {
  look: {
    ...
    room: {
      head: "Der Raum",
      note: "Drei Räume für dasselbe Brett: einer für Tageslicht, einer für den Abend und der, in dem die Nachbetrachtung eine beendete Partie liest. Einer davon kann deinem Gerät folgen, und du kannst dir weiterhin einen eigenen Raum bauen. Eine Palette setzt die Seite, die beiden Lichter, aus denen jeder Schatten geschnitten ist, und die eine Farbe, die hier bedeutet. Das Brett ist keine Palette: Es ist in allen dreien dasselbe Holz.",
      pick: "Palette {name}",
      systemName: "System",
      systemMood: "Automatisch",
      yours: "Dein Dojo",
      yoursMood: "Deiner",
      system: "Folgt deinem Gerät, das gerade {room} verlangt. Ändere das Gerät und der Raum ändert sich mit ihm.",
      built: "Ein Raum, den du selbst gebaut hast. Öffne das Dojo, um weiter daran zu arbeiten.",
      openDojo: "Öffne dein Dojo",
      buildDojo: "Bau deinen eigenen Raum",
    },
    stones: {
      head: "Deine Steine",
      note: "Ein Satz sind zwei Objekte: der Kern des schwarzen Steins und der des weißen. Die belichtete Krone und der Rand, an dem sich die Oberfläche wegkrümmt, werden aus diesen beiden berechnet, also sieht ein Satz in jedem Raum wie er selbst aus. Das Holz darunter wechselt nie.",
      pick: "Steine: {name}",
      auto: "Die des Raums",
      ...
      pass: "{name}, mit einem Kontrast von {ratio}:1 gegen einen Mindestwert von {min}. Schwarz und Weiß müssen über ein ganzes Brett hinweg und in vollem Tempo unverwechselbar sein.",
      fail: "{name} erreicht in diesem Raum nur {ratio}:1, unter dem Mindestwert von {min}. Ein anderer Satz oder ein anderer Grund im Dojo trennt sie.",
    },
    type: {
      head: "Die Schrift",
