...
export const es = {
  ...
  journal: {
    ...
    titleA: "El",
    titleEm: "diario",
    lede: "Todo lo que se ha publicado, tal como sale del registro de cambios, {notes} notas largas sobre cómo está hecho esto y {posts} sobre el juego mismo. {releases} versiones hasta ahora.",
