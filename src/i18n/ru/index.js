/* ----------------------- РУССКИЙ -----------------------
   Russian. See `shell.js` for the four decisions that shape the whole
   translation: `ты` rather than `вы`, `Рейтинг` rather than `Лестница` for
   the ladder, design-system names left alone, and Japanese go terms written
   the way the Russian books write them, by Polivanov.
