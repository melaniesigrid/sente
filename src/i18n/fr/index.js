/* ----------------------- FRANÇAIS -----------------------
   French. See `shell.js` for the two decisions that shape the whole
   translation: `tu` rather than `vous`, and `Classement` rather than `Échelle`
   for the ladder, because an échelle is the shicho and a nav button must not
   name a shape.
