...
export const lessons1 = {
  ...
  "no-liberty-capture": {
    ...
    steps: {
      ...
      1: {
        text: "La dernière liberté des blancs est à l'intérieur de leur propre forme. Aux noirs de jouer : le coup a l'air d'un suicide, mais les captures se règlent d'abord.",
  ...
  "atari-escape": {
    ...
    steps: {
      0: { text: "Il reste une liberté, et cette liberté est la seule sortie. Y étendre fait une chaîne de deux pierres avec trois libertés, et le danger est écarté pour l'instant." },
      1: {
