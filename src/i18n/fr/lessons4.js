...
export const lessons4 = {
  ...
  "classic-correctness": {
    ...
    steps: {
      0: { text: "On objecta à Zhang Ni qu'un jeu bâti sur le changement et la capture devait être une Voie fausse. Il répondit que c'est une petite Voie, mais la même Voie que la guerre, et que l'habileté qu'on y déploie n'est pas une ruse. Les meilleurs joueurs pensent profond, pèsent les conséquences lointaines et laissent leur pensée parcourir tout le goban avant de poser une pierre. Ils visent la conquête avant qu'elle soit visible, et prennent un point avant que l'adversaire y ait pensé. Il y en a un le long du bord supérieur de ce plateau." },
      1: {
