/* ----------------------- 简体中文 -----------------------
   Chinese, Simplified. See `shell.js` for the three decisions that shape the
   whole translation: 你 rather than 您, 排行榜 rather than 征 for the
   ladder, and design-system names left alone.

   One cut only, and it is Simplified. A reader on `zh-TW` lands here rather
   than on English, which is the better of two wrong answers and not a right
   one; see the note in locales.js.
