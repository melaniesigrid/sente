/* ----------------------- УКРАЇНСЬКА -----------------------
   Ukrainian. See `shell.js` for the four decisions that shape the whole
   translation: `ти` rather than `ви`, `Рейтинг` rather than `Драбинка` for
   the ladder, design-system names left alone, and Japanese go terms in
   Ukrainian phonetics rather than through the Russian Polivanov system.
