...
export const lessons1 = {
  ...
  "no-liberty-capture": {
    ...
    steps: {
      ...
      1: {
        text: "Las cinco piedras blancas tienen una sola libertad, el punto vacío dentro de su propia forma. Juegan las negras: la jugada parece un suicidio, pero las capturas se resuelven antes.",
  ...
  "atari-escape": {
    ...
    steps: {
      0: { text: "Queda una libertad, y es la única salida. Extender ahí hace una cadena de dos piedras con tres libertades, y el peligro pasa por ahora." },
      1: {
