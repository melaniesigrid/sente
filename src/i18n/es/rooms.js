...
export const rooms = {
  review: {
    ...
    advice: {
      pass: "La red pasaría aquí.",
      same: "La red también habría jugado esta jugada.",
      open: "La red abriría en el punto señalado.",
      instead: "La red habría jugado el punto señalado en su lugar.",
      from: "La red jugaría el punto señalado desde aquí.",
    },
    ...
    stop: "Parar",
    notYet: "La red todavía no ha llegado a esta jugada.",
    showBest: "Lo que le gustaba a la red",
    hideBest: "Ocultar la sugerencia",
    black: "Las negras",
    white: "Las blancas",
    blackShort: "N",
    whiteShort: "B",
    turnMove: "Jugada {move}",
    turnAria: "Jugada {move}, donde {side} perdieron {cost}",
    underAMinute: "queda menos de un minuto",
    minutesLeft: { one: "queda un minuto aproximadamente", other: "quedan unos {count} minutos" },
    networkUnreachable: "No se ha podido alcanzar la red, así que el gráfico se queda donde está.",
    graphFailed: "No se ha podido dibujar el gráfico.",
    leadB: "negras {pct}",
    leadW: "blancas {pct}",
    gives: "La red da {lead}.",
    changedLittle: "Esta jugada cambió poco.",
    moveCost: "Esta jugada le costó a {who} {moved}.",
    moveGained: "Esta jugada le ganó a {who} {moved}.",
    graphEmpty: "Gráfico de probabilidad, todavía sin analizar nada.",
    graphSummary: "Probabilidad estimada para las negras: {changed}, y para la jugada {move} de {total} la red da {who} {pct}.",
    leadChanged: { one: "la ventaja cambió de manos una vez", other: "la ventaja cambió de manos {count} veces" },
