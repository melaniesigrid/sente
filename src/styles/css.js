...
.lede { color: var(--ink-2); font-size: clamp(15px, 1.8vw, 16.5px); line-height: 1.65; margin: 0 0 6px; max-width: 58ch; }
...
.fine { color: var(--ink-2); font-size: 15px; line-height: 1.6; margin: 0; }
...
.stat-head { color: var(--ink-2); display: flex; align-items: center; gap: 9px; font-size: 14px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; }
...
.lp-display em { font-family: var(--font-display-italic); font-style: var(--display-italic-style); color: var(--accent-ink); }
.lp-h2 {
  font-family: var(--font-display); font-weight: var(--w-display);
