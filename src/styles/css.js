...
.seg-btn {
  ...
  padding: 7px 12px; font: 700 12.5px var(--font-body); letter-spacing: .04em;
...
.moku-bubble {
  ...
  font-family: var(--font-quote); font-style: var(--quote-style); font-size: 14px; line-height: 1.45; color: var(--ink);
