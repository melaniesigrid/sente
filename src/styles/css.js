...
.tile:active, .persona-card:active, .lesson-card:active, .jr-card:active, .play-choice:active, .trainer-mode:active, .nav-btn:active, .tint-dot:active, .theme-btn:active, .stone-btn:active, .legal-tab:active, .type-btn:active, .swatch:active, .look-btn:active, .lang-pill:active, .btn:active:not(:disabled), .profile-chip:active, .chat-send:active, .ladder-open:active:not(.me), .icon-btn:active, .log-next:active, .jr-back:active, .friend-who:active, .vs-open:active, .lp-btn:active, .lp-card-btn:active, .lp-enter:active, .arche-btn:active { transition-duration: .06s; }
...
.hall-line {
  ...
  overflow-wrap: anywhere; position: relative; padding-inline-end: 20px;
}
.hall-unsay {
  position: absolute; top: 1px; inset-inline-end: 0; opacity: 0;
...
.hall-table-open {
  ...
  color: var(--accent-ink); font-size: 13.5px; padding: 4px 2px; text-align: start;
}
