...
export default {
  ...
  steps: [
    ...
    },
    {
      ...
      toPlay: "b",
      answers: [pt(1, 1)],
      text: "White's five stones have a single liberty left, the empty point inside their own shape. Black to play. The move looks like suicide, but captures resolve first.",
