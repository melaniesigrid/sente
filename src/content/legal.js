  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        ...
        "Which clubs you are in, and what you are in each of them: a row on the club and an id on your record, holding the club, your standing in it — founder, keeper or member — and the day you walked in. The roll of a club is readable by the people in that club and by nobody else. Nobody is ever put into a club: joining is always a call you make yourself, which is how the sentence above about lists stays true. Walking out, being shown the door, and leaving Joseki each take your row off the club in the same breath.",
        "A club’s own record: the name and the line its founder wrote, how many are in it, whether it chose to be listed, and the code that opens it. A code is shown only to the people already inside, is never in a search result, and stops working the moment a founder issues a new one. A club that has chosen to be listed is in the same index your handle is in, and an unlisted one is in no index at all.",
        "What is said in a club’s hall: the line, who said it, and when. A line may be a board somebody put up for whoever wants a game, in which case it also holds the size, the handicap and whether it counts, and — once somebody sits down — who took it and which game it became. A hall keeps the last five hundred lines in each of its rooms and no more — older ones fall off the bottom — and it is readable only by the people in that club. It is a room and not an archive, and the screen says so before anybody puts anything in it. Anybody may take down a line they said; a keeper may take down any line. Leaving Joseki takes every line you ever said in every hall with you. Walking out of a club and being shown the door do not: you said those things in a room, to the people in it, and taking them with you would rewrite a conversation other people took part in.",
        "That you are standing in a hall, for exactly as long as you are standing in it. It is a live connection and nothing stored, the way the lobby is. This is the one place where the setting above does not decide who may see you: a room you walked into is a room the people in it can see you in, and the screen says so where you walk in.",
