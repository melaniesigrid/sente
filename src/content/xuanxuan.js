/* ----------------------- THE MYSTERIOUS CLASSIC -----------------------
   ...
   name borrowed from a story or an omen. Sente already ships its first
   ...
   Sente and settled by a solver that lives in xuanxuan.test.js: exhaustive
...
export const XUANXUAN = {
  ...
  era: "1349",
  blurb: "Life and death, from the collection of it. Sente already shelves this book's first volume under another name: it is the Classic in Thirteen Chapters.",
  credit: "Positions are Sente's own, settled by the life-and-death solver in the test suite. The book supplies the subject, not the diagrams.",
};
