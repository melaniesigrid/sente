/* ----------------------- THE ENDGAME CLASSIC -----------------------
   ...
   Joseki had no lessons in.

   Joseki does not reproduce its problems. The positions in these lessons are
...
export const GUANZI = {
  ...
  credit: "Positions are Joseki's own, settled and scored by the engine. The book supplies the subject, not the diagrams.",
};
