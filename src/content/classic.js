/* ----------------------- THE CLASSIC -----------------------
   ...
   set large between the paragraphs where a magazine would pull a line into the
   margin. It is Sente speaking, not Zhang Ni, so a view must label it as a
   gloss and never as a quotation.
