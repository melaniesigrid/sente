...
import {
  duelSeed, duelPersona, duelMode, duelState, startDuel, duelOutcome, recordDuel, duelShareText, duelShareUrl, duelResultText,
} from "./duel.js";
...
describe("daily duel", () => {
  it("seeds and hosts are fixed per day and vary across days", () => {
    ...
    expect(mode).toEqual({ kind: "duel", persona: duelPersona(personas, "2026-09-09"), seed: duelSeed("2026-09-09"), key: "2026-09-09", size: 9, handicap: 0 });
  });
