...
/* The badge carries the belt as a thin stripe under the rank, so the dojo
   ...
   whole rank it was asked to play, because that is all it was asked. `rd` is
   the rating deviation: while it is wide the rank is still a guess, and the
   badge says so with a question mark rather than pretending. */
...
/* ----------------------- A PULL QUOTE -----------------------
   ...
   paragraphs, the way a magazine pulls a line into the margin. The line is
   ours, in plain modern words, so it carries a label saying so and is never
   dressed up as a quotation of the text beside it. `label` names the voice;
   the default is the one the Classic uses. */
